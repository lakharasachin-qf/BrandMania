...
public class ImageViewPagerAdapter extends PagerAdapter {
    ...
    public ImageViewPagerAdapter(List sliderImg, Context context) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        View view = layoutInflater.inflate(R.layout.item_image_view_pager, null);

        ViewPagerItem utils = sliderImg.get(position);
        ImageView imageView = (ImageView) view.findViewById(R.id.pageView);
        ImageView frameView = (ImageView) view.findViewById(R.id.pageFrame);
