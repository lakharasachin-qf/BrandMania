...
public class UserAdapter extends ArrayAdapter<UserListModel> implements Filterable {
    ...
    UserAdapter.handleSelectionEvent selectionEvent;
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        CardView cardview=convertView.findViewById(R.id.userlist_cardview);
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked){
                    ...
                    selectionEvent.selectionEvent(hero,position,"delete");
                    hero.setSelected(false);
                }
            }
        });
