package com.app.brandadmin.Utils;

public class APIs {
  //  public static final String URL = "http://192.168.0.5/brandmania_uat/public/api/";
    public static final String URL = "http://queryfinders.com/brandmania/public/api/";
    ...
    public static final String ACTIVATE_CATEGORY = "http://queryfinders.com/brandmania/public/api/admin/changeCategoryStatus";
  public static final String GET_CATEGORY_POSITION = "http://queryfinders.com/brandmania/public/api/admin/changeCategoryPosition";
