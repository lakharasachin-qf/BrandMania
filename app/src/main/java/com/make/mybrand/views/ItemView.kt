...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        val barMargin = styles.getDimension(
            R.styleable.OtpTextView_bar_margin,
            Utils.getPixels(context, 0).toFloat()
        )
        ...
        try {
            val tf = ResourcesCompat.getFont(context, R.font.montserrat_semibold)
