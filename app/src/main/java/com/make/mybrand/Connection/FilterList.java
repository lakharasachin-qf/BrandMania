...
public final class FilterList {
    ...
    public static Filter getBlueMessFilterrrr() {
        Point[] redKnots;
        redKnots = new Point[8];
        redKnots[0] = new Point(0, 0);
        redKnots[1] = new Point(82, 34);
        redKnots[2] = new Point(102, 41);
        redKnots[3] = new Point(104, 80);
        redKnots[4] = new Point(110, 151);
        redKnots[5] = new Point(190, 214);
        redKnots[6] = new Point(225, 242);
        redKnots[7] = new Point(255, 255);
        Filter filter = new Filter();
        filter.addSubFilter(new ToneCurveSubFilter(null, redKnots, null, null));
