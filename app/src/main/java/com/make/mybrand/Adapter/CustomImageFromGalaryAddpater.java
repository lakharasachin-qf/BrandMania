...
public class CustomImageFromGalaryAddpater extends RecyclerView.Adapter<CustomImageFromGalaryAddpater.MyViewHolder> {
    Context c;
    ArrayList<ImageFromGalaryModel> spacecrafts;

    public CustomImageFromGalaryAddpater(Context c, ArrayList<ImageFromGalaryModel> spacecrafts) {
        this.c = c;
