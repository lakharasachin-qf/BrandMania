...
public class BackgroundColorsAdapter extends RecyclerView.Adapter<BackgroundColorsAdapter.ColorHolder> {
    private ArrayList<BackgroundColorsModel> arrayList;
    private Activity activity;

    private onItemSelectListener onItemSelectListener;

    public void setOnItemSelectListener(BackgroundColorsAdapter.onItemSelectListener onItemSelectListener) {
        this.onItemSelectListener = onItemSelectListener;
    }

    public interface onItemSelectListener {
        void onItemSelect(BackgroundColorsModel model, int position);
    }

    public BackgroundColorsAdapter(ArrayList<BackgroundColorsModel> fontModels, Activity activity) {
